...
# Did this to create folder within mine dir.create("~/EMBO_PopGen_2026/my_files/day7", recursive = TRUE, showWarnings = FALSE)
setwd("~/EMBO_PopGen_2026/my_files/day7")
# UNZIP the data files (in Sandra_Oliveira folder)into my folder: unzip data.zip -d ~/EMBO_PopGen_2026/my_files/day7/
...
## if there is admixture f3<0. If we don't get this, it does not mean there is no Admixture,
# it means we dont have support to say there was. Because f3 is subject to drift.
...
## all the test for neanderthal are significant. But there are some differences.
## due to higher admixture. 
...
### My own example of F4 statistics  
## see which population you want to use:
pop_meta
...
#
# In the Neanderthal introgression context (Petr et al. 2019):
#   pop1 =    (sister group of introgressing Neanderthal)
#   pop2 =                (outgroup)
#   pop3 =       (e.g., French)
#   pop4 =  (e.g., Yoruba)
#   pop5 =  (introgressing Neanderthal)

# Estimate Neanderthal admixture for  populations and plot ---
